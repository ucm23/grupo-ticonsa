...
const Teotihuacan = () => {
    ...
    let imgLayout = "plants/teotihuacan/0.jpg"
    let title = "Planta Teotihuacán"
    ...
    return (
        <>
            <NavBar photo={'true'}>
                <CarouselStatic names={[1, 2, 3, 4]} folder='plants/teotihuacan' />
                        ...
                        {[1, 2, 3, 4].map((item, key) =>
                            <Carousel.Item key={key}>
                                <div style={{ width: '100%', height: '50vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <img
                                        src={`plants/teotihuacan/${item}.jpg`}
            ...
            >
                <Modal.Header closeButton >
                    <Modal.Title>
                        Almacén de elementos prefabricados
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
