...
const Cancun = () => {
    ...
    let imgLayout = "plants/cancun/0.jpg"
    let title = "Planta Cancún T5NF1"
    ...
    return (
        <>
            <NavBar photo={'true'}>
                <CarouselStatic names={[1, 2, 3, 4]} folder='plants/cancun' />
                                        ...
                                        <div class="row-base row">
                                            <div class="col-base col-md-offset-1">
                                                <div class="col-about-info">
                                                    ...
                                                    <ol>
                                                        <li><p>Área de planta = 90,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de producción = 40,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de almacenaje = 50,000 m<sup>2</sup></p></li>
                                                        <li><p>Capacidad de producción semanal: 1,200 m<sup>3</sup></p></li>
                                                    </ol>
