...
const Campeche = () => {
    ...
    let imgLayout = "plants/campeche/0.jpg"
    let title = "Planta Campeche"
    ...
    return (
        <>
            <NavBar photo={'true'}>
                <CarouselStatic names={[1, 2, 3, 4]} folder='plants/campeche' />
                                    ...
                                    <div class="" /* col-base col-sm-6 col-md-offset-1 col-md-6  */>
                                        <Fade direction="down">
                                            <section className="text-center">
                                                <h3 class="col-about-title">{title}, <span className="text-primary-blue"> Edo. de Campeche</span></h3>
                                            </section>
                                        </Fade>
                                        <div class="row-base row">
                                            <div class="col-base col-md-offset-1">
                                                <div class="col-about-info">
                                                    ...
                                                    <ol>
                                                        <li><p>Área de planta = 40,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de producción = 20,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de almacenaje = 20,000 m<sup>2</sup></p></li>
                                                        <li><p>Capacidad de producción semanal: 700 m<sup>3</sup></p></li>
                                                    </ol>
