        ...
        <NavBar photo={true}>
            <div style={styles}>
                <Fade direction="down">
                    ...
                    <p style={{ color: 'white', fontWeight: '400', textAlign: 'center', margin: mobile ? '0 40px 0 40px' : '0 9rem 0 9rem' }}>Ya sea que estés buscando a un contratista general experto o que desees trabajar con nosotros, encuentra todo lo que necesitas para contactarte con nosotros.</p>
                </Fade>
            </div>
