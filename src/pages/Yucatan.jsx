...
const Yucatan = () => {
    ...
    let imgLayout = "plants/yucatan/0.jpg"
                                    ...
                                    <div class="" /* col-base col-sm-6 col-md-offset-1 col-md-6  */>
                                        <Fade direction="down">
                                            <section className="text-center">
                                                <h3 class="col-about-title">{title}, <span className="text-primary-blue"> Edo. de Yucatan</span></h3>
                                            </section>
                                        </Fade>
                                        <div class="row-base row">
                                            <div class="col-base col-md-offset-1">
                                                <div class="col-about-info">
                                                    ...
                                                    <ol>
                                                        <li><p>Área de planta = 30,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de producción = 15,000 m<sup>2</sup></p></li>
                                                        <li><p>Área de almacenaje = 15,000 m<sup>2</sup></p></li>
                                                        <li><p>Capacidad de producción semanal: 350 m<sup>3</sup></p></li>
                                                    </ol>
