    ...
    return (
        <form ref={form} onSubmit={sendEmail}>
            ...
            Si necesitas mejorar cualquier aspecto de un nuevo proyecto, escríbenos. Aclaramos tus dudas y te asesoramos sobre las ayudas a las que puedas tener.
                ...
                Grupo Ticonsa te informa que los datos de carácter personal que proporciones rellenando este formulario serán tratados por Grupo Ticonsa como responsable de esta web. La finalidad de la recogida y tratamiento de los datos personales que te solicitamos serán utilizados para contactar contigo para atender tu mensaje. La legitimación se realiza a través del consentimiento del interesado. El hecho de que no introduzcas los datos de carácter personal que te solicitamos como obligatorios en este formulario, puede implicar que no podamos atender tu petición. Puedes consultar información adicional en nuestra <a href={'/privacity'} target="_blank" style={{ color: color.primary }}> Aviso de Privacidad</a>.
                </p>
            </div>
        </form>
    )
