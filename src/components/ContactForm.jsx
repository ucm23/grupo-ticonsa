                            ...
                            <VStack spacing={2}>
                                <FormControl isRequired>
                                    <InputGroup>
                                        ...
                                        <Input bg={'white'} type="text" name="name" placeholder="Nombre completo" />
                                    </InputGroup>
                                </FormControl>
                                ...
                                <FormControl isRequired>
                                    <InputGroup>
                                        ...
                                        <Input bg={'white'} type="text" name="empresa" placeholder="Nombre de tu Empresa" />
                                    </InputGroup>
                                </FormControl>
                                ...
                                <FormControl isRequired>
                                    <InputGroup>
                                        ...
                                        <Input bg={'white'} type="email" name="email" placeholder="Correo electrónico" />
                                    </InputGroup>
                                </FormControl>
                                ...
                                <FormControl isRequired>
                                    <InputGroup>
                                        ...
                                        <Input bg={'white'} type="email" name="phone" placeholder="Teléfono oficina" />
                                    </InputGroup>
                                </FormControl>
                                ...
                                <FormControl isRequired>
                                    <InputGroup>
                                        ...
                                        <Input bg={'white'} type="email" name="phone" placeholder="Teléfono personal" />
                                    </InputGroup>
                                </FormControl>
