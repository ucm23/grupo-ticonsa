...
export default function ContactForm() {
    ...
    return (
        <form ref={form} onSubmit={sendEmail}>
            ...
            <input type="number" name="phone" placeholder='Teléfono personal' required />
                                ...
                                <VStack spacing={2}>
                                    <FormControl isRequired>
                                        <InputGroup>
                                            ...
                                            <Input bg={'white'} type="text" name="name" handleChange={handleChange} placeholder="Nombre completo" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl isRequired>
                                        <InputGroup>
                                            ...
                                            <Input bg={'white'} type="text" name="empresa" handleChange={handleChange} placeholder="Nombre de tu Empresa" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl isRequired>
                                        <InputGroup>
                                            ...
                                            <Input bg={'white'} type="email" name="email" handleChange={handleChange} placeholder="Correo electrónico" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl isRequired>
                                        <InputGroup>
                                            ...
                                            <Input bg={'white'} type='number' name="office" handleChange={handleChange} placeholder="Teléfono oficina" />
                                        </InputGroup>
                                    </FormControl>
                                    ...
                                    <FormControl isRequired>
                                        <InputGroup>
                                            ...
                                            <Input bg={'white'} type="number" name="phone" handleChange={handleChange} placeholder="Teléfono personal" />
                                        </InputGroup>
                                    </FormControl>
